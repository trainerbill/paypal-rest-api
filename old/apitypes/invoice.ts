import { IAddress, ICurrency, ILink, IPhone, IResponse} from "./common";
...
export interface InvoiceResponse extends IInvoice, IResponse {}
...
export interface IInvoiceListResponse extends IResponse {
    invoices: IInvoice[];
}
